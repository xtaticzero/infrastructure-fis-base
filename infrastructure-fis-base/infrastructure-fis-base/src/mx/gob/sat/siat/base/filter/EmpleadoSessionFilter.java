...
public class EmpleadoSessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        if (null == userProfileDTO) {
            ...
            logger.debug("Iniciando Session... obteniendo  de Portal AccesoUsr...");
            AccesoUsr accesoUsr = null;
            try {
                logger.debug("Obteniendo Empleado");
            ...
            if (accesoUsr == null) {
                logger.debug("No se obtuvo Usuario del empleado");
                response.sendRedirect(request.getContextPath()
                        + CommonConstants.REDIRECT_ERROR_LOGIN);
            } else {
                // Se recupero un objeto de Session de Novell
                logger.debug("Objeto accesoUsr recuperado [{}]",
    ...
    private UserProfileDTO convert(AccesoUsr accesoUsr) {
        ...
        //userProfileDTO.set accesoUsr.getNumeroEmp();
